import { DUBAI, dubaiClock, solarPosition, solarTheme } from './solar-clock.js';
export { dubaiClock, solarPosition } from './solar-clock.js';
...
function initDubaiLight() {
  ...
  function paint() {
    ...
    root.dataset.solarTheme = solarTheme(date, minutes);
    document.dispatchEvent(new Event('dubai-light-change'));
